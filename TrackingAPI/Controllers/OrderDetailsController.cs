    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public async Task<JsonResult> PickOrderByDriver(OrderPickUp CM)
        {
            try
            {
                ...
                await HubContext.Clients.All.SendAsync("BookingAccepted", CM.nLoggedInUserId, JsonConvert.SerializeObject(CM), JsonConvert.SerializeObject(table));
                return new JsonResult(table);
            }
            catch (Exception ex) { throw ex; }
        }
        ...
        public async Task<JsonResult> UpdateOrder_DestinationReachedEndTimeByDriver(OrderDetails CM)
        {
            try
            {
                ...
                await HubContext.Clients.All.SendAsync("BookingEnd", CM.nLoggedInUserId, JsonConvert.SerializeObject(table));
                return new JsonResult(table);
            }
            catch (Exception ex) { throw ex; }
        }
